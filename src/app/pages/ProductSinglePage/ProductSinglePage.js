...
import { fetchAsyncProductSingle, getProductSingle, getSingleProductStatus } from '../../../lib/Features/productSlice';
import { STATUS } from '../../utils/status';
import Loader from "../../components/Loader/Loader";
import { formatPrice } from "../../utils/helpers";
import { useRouter } from 'next/router';
import { FaPlus, FaMinus } from 'react-icons/fa';
import { addToCart, getCartMessageStatus, setCartMessageOff, setCartMessageOn } from '../../../lib/Features/cartSlice';
import CartMessage from '@/app/components/CartMessage/CartMessage';
                    ...
                    <div className='product-single-content bg-white grid'>
                        ...
                        <div className='product-single-r'>
                            <div className='product-details font-manrope'>
                                <div className='title fs-20 fw-5'>{product?.title}
                                </div>
                                <div>
                                ...
                                <div className='info flex align-center flex-wrap fs-14'>
                                    <div className='rating'>
                                        <span className='text-black fw-5'>Rating:</span>
                                        <span className='mx-1'>
                                            {product?.rating}
                                        </span>
                                    </div>
                                ...
                                <div className="price">
                                    ...
                                    <div className='flex align-center my-1'>
                                        ...
                                        <div className='discount bg-black fs-13 text-white fw-6 font-poppins'>
