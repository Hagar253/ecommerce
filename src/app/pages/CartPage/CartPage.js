...
import { getAllCarts, removeFromCart, toggleCartQty, clearCart, getCartTotal } from '../../../lib/Features/cartSlice';
        ...
        return (
            <div className='container my-5'>
                <div className='empty-cart flex justify-center align-center flex-column font-manrope'>
                    ...
                    <Link href="/" className='shopping-btn bg-black text-white fw-5'>Go shopping Now</Link>
                </div>
            </div>
        )
    }
